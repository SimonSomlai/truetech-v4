  ...
  $.fn.tagsInput = function (options) {
    ...
    this.each(function () {
      ...
      if (settings.initialValues) {
        console.log("initialvalues", settings.initialValues);
        $.fn.tagsInput.importTags($(data.real_input), settings.initialValues);
      }
      ...
      if (settings.interactive) {
        ...
        if (settings.autocomplete_url != undefined) {
          ...
          if (jQuery.Autocomplete !== undefined) {
            $(data.fake_input).autocomplete({
              serviceUrl: settings.autocomplete_url,
              width: "300px",
              autoSelectFirst: false,
              onSelect: function (item) {
                console.log("select", item);
                $("#" + id).addTag(item.value + "", {
                  focus: true,
