/* PrismJS 1.25.0
https://prismjs.com/download.html?#themes=prism-solarizedlight&languages=markup+css+clike+javascript+bash+graphql+json+markdown+markup-templating+perl+php+python+jsx+tsx+ruby+sass+scss+typescript+yaml&plugins=line-highlight */
